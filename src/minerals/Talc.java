...
public class Talc extends MineralPhase {

	
	public static int ideal_cation_sum=7; //
	public static Double mineralOssigeniI=11.00; //totale ossigeni TEORICI per il ricalcolo del mineral
	public static String mineralNameString="talc";
	
	
	
	public Talc(String[] tokenizedLineStrings, ArrayList<Oxydes> listaOxTmp,
