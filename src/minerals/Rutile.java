...
public class Rutile extends MineralPhase {
	...
	public static String mineralNameString="rutile";
	
	
	
	public Rutile(String[] tokenizedLineStrings, ArrayList<Oxydes> listaOxTmp,
