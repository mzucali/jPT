...
public class Sapphirine extends MineralPhase {
	// Ca2Al3Si3O13H - zoisite/clinozoisite
	// Ca2FeAl2Si3O13H - epidote
	// Ca2Fe2AlSi3O13H - Fe-epidote
	//
	
	public static int ideal_cation_sum=14; //
	public static Double mineralOssigeniI=20.00; //totale ossigeni TEORICI per il ricalcolo del mineral
	public static String mineralNameString="sapphirine";
	
	
	
	public Sapphirine(String[] tokenizedLineStrings, ArrayList<Oxydes> listaOxTmp,
