...
public class Analcime extends MineralPhase {
	// leucite
	...
	public static String mineralNameString="analcime";
	

	
	public Analcime(String[] tokenizedLineStrings, ArrayList<Oxydes> listaOxTmp,
