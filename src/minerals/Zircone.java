...
public class Zircone extends MineralPhase {
	...
	public static String mineralNameString="zircon";
	
	
	
	public Zircone(String[] tokenizedLineStrings, ArrayList<Oxydes> listaOxTmp,
