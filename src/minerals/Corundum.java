...
public class Corundum extends MineralPhase {

	
	public static int ideal_cation_sum=2; //
	public static Double mineralOssigeniI=3.00; //totale ossigeni TEORICI per il ricalcolo del mineral
	public static String mineralNameString="corundum";
	
	
	
	public Corundum(String[] tokenizedLineStrings, ArrayList<Oxydes> listaOxTmp,
