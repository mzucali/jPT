...
public class Spinel extends MineralPhase {
	...
	public static String mineralNameString="spinel";
	
	
	
	public Spinel(String[] tokenizedLineStrings, ArrayList<Oxydes> listaOxTmp,
