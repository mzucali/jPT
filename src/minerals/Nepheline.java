...
public class Nepheline extends MineralPhase {

	
	public static int ideal_cation_sum=3; //
	public static Double mineralOssigeniI=32.00; //totale ossigeni TEORICI per il ricalcolo del mineral
	public static String mineralNameString="nepheline";
	
	
	
	public Nepheline(String[] tokenizedLineStrings, ArrayList<Oxydes> listaOxTmp,
