...
public class Cordierite extends MineralPhase {
	...
	public static String mineralNameString="cordierite";
	...
	public Cordierite(String[] tokenizedLineStrings, ArrayList<Oxydes> listaOxTmp,
