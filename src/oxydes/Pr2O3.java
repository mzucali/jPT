...
public class Pr2O3 extends Oxydes {

    /**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private static final int ID_COMP_I = 23;
    private  final Double PESO_MOLECOLARE_D = 329.813;
    private  final int FATTORE_MOLTIPLICATIVO = 3;
    private  final Double FATTORE_DIVISIONE_D = 0.666667;

    private  final String oxyLabel= "Pr2O3";
    private  final String catLabel = "Pr";

    private Double oxyVal;
    private Double catVal;

    private Integer posizionePr2O3;
  ...
  //  private static final Double PESO_MOLECOLARE_D = 0.01;
    ...
    public Pr2O3(Double aOxValueDouble){
	...
	public Integer getPosizionePr2O3() {
		return posizionePr2O3;
	}

	public void setPosizionePr2O3(Integer posizionePr2O3) {
		this.posizionePr2O3 = posizionePr2O3;
	}
