   import java.awt.*;
        ...
        public final class PeriodicTable extends Frame {
            ...
            private static Label createLabel(String text, GridBagLayout gb,
            ...
            private static Button createButton(String elemName,
                    GridBagLayout gb, GridBagConstraints gbc, Frame frame) {
                Element elem = JSci.chemistry.PeriodicTable
                        .getElement(elemName);
                if (elem == null)
                    return null;
